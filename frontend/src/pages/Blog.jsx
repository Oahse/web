...
export const Blog = () => {
    ...
    const fetchPosts = async () => {
      try {
        ...
        await fetchBlogPosts(() =>
          BlogAPI.getBlogPosts(params.page, params.limit, params.is_published, params.search)
        );
      } catch (err) {
  ...
  const categories = ['All', 'Technology', 'Health', 'Food', 'Travel'];
  const popularTags = ['Organic', 'Farming', 'Sustainable', 'Africa', 'Healthy'];
  const blogPosts = [];
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3">
          ...
          {loading ? (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <div>
                          <p className="font-medium text-main dark:text-white">{post.author_id}</p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 text-center border border-gray-100 dark:border-gray-700">
              <h2 className="text-xl font-semibold text-main dark:text-white mb-2">No articles found</h2>
          ...
          {blogPostsData?.pagination && blogPostsData.pagination.pages > 1 && (
            <div className="flex items-center justify-center space-x-2 mt-8">
              ...
              <button
                onClick={() =>
                  setCurrentPage((prev) => Math.min(blogPostsData.pagination.pages, prev + 1))
                }
        ...
        <div className="lg:w-1/3">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6 border border-gray-100 dark:border-gray-700">
            <h3 className="font-semibold text-lg text-main dark:text-white mb-4">Search</h3>
            <form onSubmit={handleSearch}>
              <div className="relative">
                <input
                  type="text"
                  placeholder="Search articles..."
                  className="w-full px-4 py-2 pr-10 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-1 focus:ring-primary dark:bg-gray-700 dark:text-white"
                  value={searchTerm}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6 border border-gray-100 dark:border-gray-700">
            <h3 className="font-semibold text-lg text-main dark:text-white mb-4">Filter</h3>
          ...
          {/* Categories */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6 border border-gray-100 dark:border-gray-700">
            <h3 className="font-semibold text-lg text-main dark:text-white mb-4">Categories</h3>
          ...
          {/* Popular Tags */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6 border border-gray-100 dark:border-gray-700">
            <h3 className="font-semibold text-lg text-main dark:text-white mb-4">Popular Tags</h3>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-100 dark:border-gray-700">
            <h3 className="font-semibold text-lg text-main dark:text-white mb-4">Recent Posts</h3>
