...
export const AdminDashboard = () => {
  ...
  } = useApi(AdminAPI.getAdminStats, { autoFetch: true, showErrorToast: false });
  ...
  } = useApi(AdminAPI.getPlatformOverview, { autoFetch: true, showErrorToast: false });

  const getAllOrdersCallback = () => AdminAPI.getAllOrders({ page: 1, limit: 5 });
