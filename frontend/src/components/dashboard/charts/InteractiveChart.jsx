 ...
 * @property {(number | { x: string | Date; y: number })[]} data
 ...
 * @property {ChartData} [key: string]
 */

/**
 * @typedef {object} InteractiveChartProps
 * @property {'line' | 'bar' | 'pie' | 'doughnut' | 'area'} type
 * @property {ChartData} data
 * @property {string} [title]
 * @property {number} [height=300]
 * @property {boolean} [showTooltips=true]
 * @property {boolean} [showLegend=true]
 * @property {boolean} [enableDrillDown=false]
 * @property {DrillDownData} [drillDownData]
 * @property {(dataPoint: { dataIndex: number; datasetIndex: number; label?: string; value: number | { x: string | Date; y: number } }, index: number) => void} [onDataPointClick]
 * @property {('png' | 'pdf' | 'csv') => void} [onExport]
 * @property {boolean} [refreshable=false]
