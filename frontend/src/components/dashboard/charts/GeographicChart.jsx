...
/**
 * @typedef {object} GeographicDataPoint
 * @property {string} country
 * @property {string} countryCode
 * @property {import('leaflet').LatLngExpression} coordinates
...
/**
 * @typedef {object} GeographicChartProps
 * @property {GeographicDataPoint[]} data
 * @property {string} [title]
 * @property {number} [height=400]
 * @property {'map' | 'list' | 'chart'} [viewMode='map']
 * @property {boolean} [showPercentages=true]
 * @property {boolean} [showTooltips=true]
 * @property {string[]} [colorScale=['#fee5d9', '#fcae91', '#fb6a4a', '#de2d26', '#a50f15']]
 * @property {(country: GeographicDataPoint) => void} [onCountryClick]
 * @property {(mode: 'map' | 'list' | 'chart') => void} [onViewModeChange]
