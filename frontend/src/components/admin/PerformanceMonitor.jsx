 ...
 * @property {{cpu_percent: number; memory_percent: number; disk_percent: number; uptime_seconds: number;}} system_metrics
 * @property {Array<{id: string; metric_name: string; severity: string; message: string; timestamp: string;}>} active_alerts
 * @property {{avg: number; min: number; max: number; count: number;}} response_time_summary
 * @property {string} monitoring_status
 */

/**
 * @typedef {object} CacheStats
 * @property {{size: number; max_size: number; hit_ratio: number;}} [cacheName]
 */
