/**
 * Tests for DeleteShippingMethodModal.tsx
 */
...
describe('DeleteShippingMethodModal', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should render without crashing', () => {
    ...
    expect(screen.getByRole('main') || screen.getByTestId('deleteshippingmethodmodal') || document.body).toBeInTheDocument();
  });
