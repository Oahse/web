 ...
 * }>} recent_orders
 * @property {{top_selling: Array<{id: string; name: string; sales_count: number; revenue: number;}>; low_stock: Array<{id: string; name: string; stock: number; threshold: number;}>;}} product_performance
 * @property {Array<{
 *   id: string;
 *   product_name: string;
