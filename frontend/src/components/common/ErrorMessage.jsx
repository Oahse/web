 ...
 * @property {object | Error | string | null} [error]
 * @property {string} [className='']
 * @property {boolean} [showIcon=true]
 * @property {'default' | 'inline' | 'banner'} [variant='default']
...
const ErrorMessage = ({
  ...
  if (!error) {
    ...
    if (typeof error.message === 'string') {
      ...
      message = error.message.message || JSON.stringify(error.message);
    } else {
                ...
                {details.map((detail, index) => (
                  <li key={index}>
                    {typeof detail === 'string' 
                      ? detail 
                      : (detail.message || detail.field || JSON.stringify(detail))
                    }
                  </li>
                ))}
              </ul>
