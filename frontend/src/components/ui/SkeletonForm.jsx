...
export const SkeletonLoginForm = (props) => (
  <SkeletonForm fields={2} {...props} />
);

export const SkeletonRegistrationForm = (props) => (
  <SkeletonForm fields={5} layout="grid" {...props} />
);

export const SkeletonProfileForm = (props) => (
  <SkeletonForm fields={8} layout="grid" variant="detailed" {...props} />
);

export const SkeletonProductForm = (props) => (
