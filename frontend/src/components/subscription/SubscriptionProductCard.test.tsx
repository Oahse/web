/**
 * Tests for SubscriptionProductCard.tsx
 */
...
describe('SubscriptionProductCard', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should render without crashing', () => {
    ...
    expect(screen.getByRole('main') || screen.getByTestId('subscriptionproductcard') || document.body).toBeInTheDocument();
  });
