    ...
    <div>
      ...
      {items.length > 0 ? (
                  ...
                  {items.map((item) => (
                    <tr key={item.id} className="border-b dark:border-gray-700">
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          ...
                          <Link
                            ...
                            className="font-medium text-main dark:text-white hover:text-primary"
                          >
                      ...
                      <td className="px-6 py-4 text-right font-medium text-main dark:text-white">
                        $
                        {item.product?.variants?.[0]?.base_price?.toFixed(2) ||
                          '0.00'}
                      </td>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 text-center">
          ...
          <Link
            to="/products"
            className="inline-block px-4 py-2 bg-primary hover:bg-primary-dark text-white rounded-md"
          >
            Browse Products
          </Link>
        </div>
