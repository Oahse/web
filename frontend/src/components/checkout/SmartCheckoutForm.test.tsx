/**
 * Tests for SmartCheckoutForm.tsx
 */
...
describe('SmartCheckoutForm', () => {
  ...
  it('should render without crashing', () => {
    ...
    expect(screen.getByRole('main') || screen.getByTestId('smartcheckoutform') || document.body).toBeInTheDocument();
  });
